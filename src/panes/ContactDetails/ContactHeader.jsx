  ...
  return (
    <div className={styles.header}>
      ...
      <div className={styles.headerProfile}>
        <Avatar url={header.avatarUrl} name={header.displayName} size={32} />
      ...
      <div className={styles.headerMetaGrid}>
        <div className={styles.headerMetaCell}>
          ...
          <DropdownMenu.Root>
            <DropdownMenu.Trigger className={styles.headerOwnerTrigger}>
              ...
              <span>{header.owner?.name ?? '—'}</span>
              <ChevronDownIcon />
            </DropdownMenu.Trigger>
            <DropdownMenu.Portal>
              <DropdownMenu.Content className={styles.actionMenu} sideOffset={6}>
                <DropdownMenu.Item className={styles.actionMenuItem}>Devon Lane</DropdownMenu.Item>
        ...
        <div className={styles.headerMetaCell}>
          ...
          <div className={styles.headerFollowers}>
      ...
      <div className={styles.headerTagRow}>
        ...
        <div className={styles.headerTags}>
          {(header.tags ?? []).map((t) => (
            <Chip key={t} tone={t.toLowerCase().includes('vip') ? 'vip' : 'tag'}>
              {t}
              <button
                type="button"
          ...
          {header.tagsOverflow > 0 ? <Chip tone="overflow">+{header.tagsOverflow}</Chip> : null}
